...
// --- KONSTANTA & DATA (Akan dipindah ke API nanti) ---
const GAME_STATES = {
    DASHBOARD: 'dashboard',
    LOADING: 'loading',
    PLAYING: 'playing',
...
const quests = {
    /* ... (Salin seluruh objek 'quests' besar Anda di sini) ... */
...
const safeLocalStorage = { /* ... (fungsi safeLocalStorage tidak berubah) ... */ };
const validateMiniGame = (type, userAnswer, minigameData) => { /* ... (fungsi validateMiniGame tidak berubah) ... */ };
const getBadge = (stats) => { /* ... (fungsi getBadge tidak berubah) ... */ };
