...
// ... (Konstanta GAME_STATES, STATS, dan objek 'quests' tetap sama)
const GAME_STATES = {
    DASHBOARD: 'dashboard',
    LOADING: 'loading',
    PLAYING: 'playing',
...
export const useGameStore = create((set, get) => ({
    ...
    handleChoice: (choice) => {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                if (isLastScene) {
                    get().endQuest(); // Panggil fungsi endQuest yang baru
                    return;
                }
    ...
    // ... (fungsi completeMinigame tetap sama, tapi pastikan di akhir dia memanggil endQuest jika skenario terakhir)
